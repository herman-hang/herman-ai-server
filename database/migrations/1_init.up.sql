/*
 ...
 Source Schema         : herman_ai

 Target Server Type    : MySQL
 Target Server Version : 80012
 File Encoding         : 65001

 Date: 31/07/2023 00:05:31
*/
...
(
    ...
    `photo_id`     int(255) UNSIGNED NULL DEFAULT NULL COMMENT '头像ID',
    ...
    UNIQUE INDEX `uk_user`(`user` ASC) USING BTREE COMMENT '管理员用户名索引'
...
VALUES (1, 'admin', '$2a$10$e3Jv5Fa7WU0e5c9QTYjEQ.G1E6ex30Q404DzmBwUsZoNBASvPsZty',
        0, '超级管理员', '650000197000000000', 3, 100, '中国北京',
...
(
    ...
    `path`       varchar(100) CHARACTER SET utf8 COLLATE utf8_general_ci NOT NULL COMMENT '请求路由',
...
(
    ...
    `deleted_at` datetime NULL DEFAULT NULL COMMENT '删除时间',
    PRIMARY KEY (`id`) USING BTREE,
    UNIQUE INDEX `uk_code`(`code` ASC) USING BTREE COMMENT '唯一标识码索引'
...
(
    ...
    `chunk_path`   varchar(255) CHARACTER SET utf8 COLLATE utf8_general_ci NULL DEFAULT NULL COMMENT '分片路径',
    `hash`         varchar(255) CHARACTER SET utf8 COLLATE utf8_general_ci NULL DEFAULT NULL COMMENT '分片hash值',
...
(
    ...
    `drive`      varchar(10) CHARACTER SET utf8 COLLATE utf8_general_ci  NOT NULL COMMENT '文件存储驱动(local:本地，oss:阿里云OSS，cos:腾讯云COS，qiniu:七牛云)',
    ...
    `file_path`  varchar(255) CHARACTER SET utf8 COLLATE utf8_general_ci NULL DEFAULT NULL COMMENT '文件路径名',
...
(
    ...
    `deleted_at`   datetime NULL DEFAULT NULL COMMENT '删除时间',
    PRIMARY KEY (`id`) USING BTREE,
    UNIQUE INDEX `uk_role`(`role` ASC) USING BTREE COMMENT '角色名索引',
    INDEX          `idx_id_role`(`id` ASC, `role` ASC) USING BTREE
...
(
    ...
    `is_website`   tinyint(4) NULL DEFAULT 2 COMMENT '网站开关（1：关，2开）',
    `email`        varchar(32) CHARACTER SET utf8 COLLATE utf8_general_ci NULL DEFAULT NULL COMMENT '邮箱',
...
(
    ...
    `photo_id`     int(10) UNSIGNED NULL DEFAULT NULL COMMENT '用户头像ID',
